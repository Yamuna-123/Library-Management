        ...
        <?php session_start();
            ...
            if($_SESSION['srole']=='A'){
                $sql="SELECT Book_Id,Book_Name,Author_Name,Pub_Year,Price,book.Catg_Id,category.Catg_Name,
                    Status FROM book INNER JOIN category on book.Catg_Id=category.Catg_Id";
            }else{
                $sql="SELECT Book_Id,Book_Name,Author_Name,Pub_Year,Price,book.Catg_Id,category.Catg_Name,
                Status FROM book INNER JOIN category on book.Catg_Id=category.Catg_Id where Status='Active'"; 
            }
