            ...
            if($id=='all'){
                ...
                if($_SESSION['srole']=='A'){
                    $sql="SELECT Book_Id,Book_Name,Author_Name,Pub_Year,Price,book.Catg_Id,category.Catg_Name,
                        Status FROM book INNER JOIN category on book.Catg_Id=category.Catg_Id where Book_Id='$id'";
                }else{
                    $sql="SELECT Book_Id,Book_Name,Author_Name,Pub_Year,Price,book.Catg_Id,category.Catg_Name,
                    Status FROM book INNER JOIN category on book.Catg_Id=category.Catg_Id where Status='Active' AND Book_Id='$id'"; 
                }
            }
            $sqlh=new library();
